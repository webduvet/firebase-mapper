...
Zz.ModelFactory.prototype.create = function(url){
	return new Zz.Model(this.ref, url, ref);
}
...
/*
 * watch local property and propagate any change stright away into database
...
Object.defineProperty(Zz.Model.prototype, "watchRemote", {
	...
	value: function(prop, event){
		...
		var change = function(ss){
			console.log(event, 'triggered ', ss.val());
			if (ss.val() !== this[prop]) { 
				this[prop] = ss.val();
