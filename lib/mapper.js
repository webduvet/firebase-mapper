...
Zz.ValueFactory = function(ref){
	this.ref = ref;
}

Zz.ValueFactory.prototype.create = function(url){
	return new Zz.Value(url, ref);
}

Zz.Value = function(ref, url, blueprint){
	// TODO eval blueprint
...
Object.defineProperty(Zz.Value.prototype, 'aprop', {
	  enumerable: false
	, writable: false
	, configurabl: false
	, value: function(prop){
...
Object.defineProperty(Zz.Value.prototype, "on", {
	  enumerable: false
	, configurable: true
	, writable: false
...
Object.defineProperty(Zz.Value.prototype, "off", {
	  enumerable: false
	, configurable: true
	, writable: false
	, value: function(event, handler){
...
Object.defineProperty(Zz.Value.prototype, "write", {
	  enumerable: false
	, configurable: true
	, writable: false
	, value: function(){
...
Object.defineProperty(Zz.Value.prototype, 'trigger', {
	  enumerable: false
	, configurable: true
	, writable: false
...
Object.defineProperty(Zz.Value.prototype, 'set', {
	  enumerable: false
	, configurable: true
	, writable: false
	, value: function(data){
		switch (typeof data){
			case "undefined" : 
				throw new Error("Zz.Value.set can't accept undefined as value");
				break;
			case "null" : 
				throw new Error("Zz.Value.set can't accept undefined as value");
				break;
