 ...
 */
Zz.ModelFactory = function(model, ref){
	this.ref = ref;
	this.Model = model
}

/**
 * decorates the instance of new created model
 * @decorator
 * @access public
 *
 ...
 */
Zz.ModelFactory.prototype.addAction = function(name, handler){
}
...
Zz.ModelFactory.prototype.create = function(url, blueprint){
	return new this.Model(this.ref, url, blueprint);
}
