...
Fm.List = function(ref, config) {
	...
	if (config.factory instanceof Fm.ModelFactory) {
		console.log ('factory config is factory instance');
		...
		console.log("ModelFactory:",this.factory instanceof Fm.ModelFactory, "ReferenceFactory:", this.factory instanceof Fm.ReferenceFactory);
	}
