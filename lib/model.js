 ...
 */
var Model = module.exports = function(ref, blueprint){
	// TODO eval blueprint
	...
	for(var key in blueprint){
		if (Array.isArray(blueprint[key])){
			...
			if(type === 'model') {
				this[key] = (new ModelFactory(bp, ref)).create();
			} else if (type ==='list' ) {
 ...
 * need to investigate 
 */
Object.defineProperty(Model.prototype, 'aprop', {
	  enumerable: false
	, writable: false
	, configurabl: false
	, value: function(prop){
 ...
 */
Object.defineProperty(Model.prototype, "load", {
	  enumerable: false
	, configurable: true
	, writable: false
	, value: function(){
...
Object.defineProperty(Model.prototype, "loadWithData", {
	  enumerable: false
	, configurable: true
	, writable: false
	, value: function(data){
 ...
 * @access public
 */
Object.defineProperty(Model.prototype, "writeProp", {
	  enumerable: false
	, configurable: true
	, writable: false
	, value: function(prop){
 ...
 * @access private
 */
Object.defineProperty(Model.prototype, '__trigger', {
	  enumerable: false
	, configurable: true
	, writable: false
 ...
 */
Object.defineProperty(Model.prototype, "__updatelocal", {
	enumerable: false,
	configurable: true,
	writable: false,
	value: function(prop, val){
		this[prop] = val;
		//Model.prototype.__trigger.call(this, 'update', prop);
	}
});
 ...
 * @param{string} property descriptor
 */
Object.defineProperty(Model.prototype, "unwatchLocal", {
	  enumerable: false
	, configurable: true
	, writable: false
	, value: function (prop) {
 ...
 */
Object.defineProperty(Model.prototype, "watchRemote", {
	enumerable: false,
	configurable: true,
	writable: false,
 ...
 */
Object.defineProperty(Model.prototype, "unwatchRemote", {
	enumerable: false,
	configurable: true,
	writable: false,
	value: function(prop, event){
...
Object.defineProperty(Model.prototype, "__watch", {
		enumerable: false
	, configurable: true
	, writable: false
	, value: function (prop, handler) {
...
// object.unwatch
Object.defineProperty(Model.prototype, "__unwatch", {
		enumerable: false
	, configurable: true
	, writable: false
	, value: function (prop) {
 ...
 */
Object.defineProperty(Model.prototype, 'populate', {
	  enumerable: false
	, configurable: true
	, writable: false
	, value: function(data){
		switch (typeof data){
			case "undefined" : 
				throw new Error("Model.set can't accept undefined as value");
				break;
			case "null" : 
				throw new Error("Model.set can't accept undefined as value");
				break;
 ...
 * @param {object || primitive} new value
 */
Object.defineProperty(Model.prototype, 'setProp', {
	  enumerable: false
	, configurable: true
	, writable: false
