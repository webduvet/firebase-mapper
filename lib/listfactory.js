 ...
 */
Fm.ListFactory = function(ref, blueprint) {
	this.ref = ref;
	...
	if (this.blueprint.modelFactory instanceof Fm.ModelFactory) throw "Invalid argument in ModelFactory";
	if (this.blueprint.priorityProvider instanceof Fm.PriorityProvider ) throw "Invalid argument in PriorityProvider";
