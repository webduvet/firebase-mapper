 ...
 * @access public
 */
Fm.Basic.prototype.save = function(){
 ...
 */
Fm.Basic.prototype.load = function(){
...
Fm.Basic.prototype.loadWithData = function(data){
	if (!data){
		this.__trigger("error", "nothing in DB in that location");
	}
	else {
 ...
 * @access public
 */
Fm.Basic.prototype.saveProp = function(prop){
	try {
...
Fm.Basic.prototype.watchLocal = function(prop){
 ...
 * @param{string} property descriptor
 */
Fm.Basic.prototype.unwatchLocal = function (prop) {
	var val = this[prop];
 ...
 */
Fm.Basic.prototype.watchRemote = function(prop, event){
	/**
	 * @param {snaphot}
	 */
 ...
 */
Fm.Basic.prototype.unwatchRemote = function(prop, event){
 ...
 */
Fm.Basic.prototype.populate = function(data){
	switch (typeof data){
		case "undefined" : 
