...
Fm.Reference = function(modelFactory, id, blueprint){
	Fm.Basic.call(this, modelFactory, id, blueprint);
...
Fm.ReferenceFactory = function(ref, blueprint, ReferenceModel) {
	...
	console.log("blueprint of reference", blueprint);
	console.log("this Reference Factory is instance of ModelFactory", this instanceof Fm.ModelFactory);
};
