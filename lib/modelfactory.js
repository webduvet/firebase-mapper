 ...
 */
var ModelFactory = module.exports = function(ref, blueprint){
	this.ref = ref;
 ...
 */
ModelFactory.prototype.decorateCreate = function(name, fn){
...
ModelFactory.prototype.decorateModelsMethod = function(name, fn){
};

/**
 * removes all previous decorators on create method
 */
ModelFactory.prototype.unDecorateCreate = function(){
 ...
 */
ModelFactory.prototype.decorateAction = function(method, decorator){
};
 ...
 */
ModelFactory.prototype.create = function(ref){
